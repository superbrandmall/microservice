...
import com.sbm.module.common.data.biz.IBusinessTemplateService;
 ...
 * @param <ID> 主键
 */
public abstract class BusinessTemplateServiceImpl<T, K, ID extends Serializable> extends BusinessServiceImpl<T, K> implements IBusinessTemplateService<T, K, ID> {
