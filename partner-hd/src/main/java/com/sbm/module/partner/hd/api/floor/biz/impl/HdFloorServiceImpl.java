...
public class HdFloorServiceImpl extends CommonServiceImpl implements IHdFloorService {
	...
	public List<HdFloor> findAll() {
		return map(service.findAll(), e -> new HdFloor(e.getHdUuid(), e.getHdCode(), e.getFloorName(), e.getBuildingUuid(), e.getMallUuid(), e.getState(), e.getGrossFloorArea(), e.getLeasingArea(), e.getDescription()));
	}
}
