...
public class Shop {
	...
	public Shop(String code, String brandCode, String mallCode, String buildingCode, String floorCode, String unit, String shopName, BigDecimal area, Integer state, String hdState, String hdCode) {
		this.code = code;
