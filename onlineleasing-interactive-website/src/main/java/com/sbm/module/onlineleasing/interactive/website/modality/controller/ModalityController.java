package com.sbm.module.onlineleasing.interactive.website.modality.controller;
...
public class ModalityController extends BaseController {
	...
	public JsonContainer<Page<Modality>> findAll(@RequestBody ModalityQuery query, @PageableDefault Pageable pageable) {
