...
//		// 图片
//		try {
//			MultipartFile[] files = new MultipartFile[]{new MockMultipartFile(vo.getName(), new FileInputStream(vo))};
//			Upload upload = new Upload(new FileUploadDetail(), files);
//			JsonContainer<List<UploadResult>> result = client.multi(upload);
